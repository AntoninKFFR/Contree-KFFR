...
Le tri est une copie de présentation : il ne modifie ni les objets `Card`, ni leur identité dans le moteur. Les modes disponibles sont couleur/valeur et valeur/couleur. L'ancien choix « Manuel », qui ne proposait pas de réorganisation persistante réelle, est normalisé vers couleur/valeur et n'est plus exposé. Désactiver le tri automatique conserve l'ordre reçu. L'ordre des quatre couleurs est configurable avec des contrôles haut/bas et un aperçu visuel. En mode couleur/valeur, les couleurs présentes sont temporairement disposées en alternant rouge et noir lorsque c'est possible, tout en préservant leur ordre relatif de préférence ; ce calcul ne modifie pas l'ordre enregistré. Les contrats couleur, Sans Atout et Tout Atout passent tous leur mode explicite au tri.
