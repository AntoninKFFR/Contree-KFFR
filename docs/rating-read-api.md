...
`get_rating_leaderboard(p_limit := 50, p_offset := 0)` accepte une limite de 1 à 100 et un offset positif ou nul. Seuls les joueurs ayant au moins cinq parties appliquées sont inclus.
